...
Playgrab = {
    ...
    displayTrack: function(artist, title) {
        ...
        li.find('a').click(function(e) {
            ...
            var iframe = $("<iframe class='iframe-tomahk' scrolling='no' style='border:none;position:fixed;top:30px;left:0;z-index:9999999;background:#000;opacity:0' class='tomahk-iframe' width=278 height=278 src='http://"+domain+"/embed.php?artist="+encodeURIComponent(artist)+"&title="+encodeURIComponent(title)+"&autoplay=true'></iframe>");
